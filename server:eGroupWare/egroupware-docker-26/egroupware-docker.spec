...
# create with: tar -czvf egroupware-docker-26.2.20260207.tar.gz egroupware-docker
...
EOF
  ...
  2)# This is an upgrade.
	...
	test -f docker-compose.override.yml && {
	  ...
	  sed -i docker-compose.override.yml -e 's/^\( *image\):\(.*\):2[13].1$/\1:\2:26/g' || true
